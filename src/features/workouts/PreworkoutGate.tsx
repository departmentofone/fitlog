export function PreworkoutGate({ onAnswer, loading }: { onAnswer: (preworkout: boolean) => void; loading?: boolean }) {
  return (
    <div className="p-4">
      <div className="rounded-2xl bg-slate-900 p-5 text-center shadow-lg shadow-black/20 ring-1 ring-white/5">
        ...
        <div className="flex justify-center gap-3">
          ...
          <button
            ...
            className="rounded-lg bg-slate-800 px-5 py-2.5 font-medium text-slate-200 transition hover:bg-slate-700 disabled:opacity-50"
          >
            No
          </button>
        </div>
