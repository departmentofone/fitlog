    ...
    <div className="space-y-4 p-4">
      ...
      <div className="rounded-3xl bg-slate-900 border-t border-white/10 p-4 shadow-lg shadow-black/20 ring-1 ring-white/5">
        ...
        <p className="text-sm leading-relaxed text-slate-400">
          ...
          alongside them. Open <span className="font-medium text-slate-200">Settings (in the header)</span> to
      ...
      <div className="rounded-3xl bg-slate-900 border-t border-white/10 p-4 shadow-lg shadow-black/20 ring-1 ring-white/5">
        ...
        <a
          ...
          className="inline-block rounded-xl bg-emerald-600 px-4 py-2 text-sm font-medium text-on-accent hover:brightness-90"
        >
